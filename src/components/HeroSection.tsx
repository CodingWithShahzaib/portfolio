    ...
    <section id="home" className="w-full overflow-hidden">
      <AuroraBackground className="h-screen">
        ...
        <motion.div
          ...
          className="flex flex-col items-center justify-center h-full w-full relative z-10 text-center px-4 sm:px-6 pt-28 sm:pt-20 md:pt-0 pb-24 sm:pb-20 md:pb-16"
        >
          ...
          <div className="mt-6 sm:mt-8 md:mt-10 flex flex-col items-center justify-center w-full mb-8 sm:mb-12 md:mb-0">
            {/* Desktop Layout - All buttons in a row */}
            <div className="hidden sm:flex flex-row gap-4 md:gap-6 justify-center items-center">
              {/* LinkedIn Button */}
              <a href="https://www.linkedin.com/in/shahzaib-rehman-1246591a6/" target="_blank" rel="noopener noreferrer">
                <Button
                  borderRadius="1.75rem"
                  className="bg-black text-white border border-neutral-800 hover:bg-black/90 hover:border-neutral-700 px-6 md:px-8 py-3 md:py-4"
                >
              ...
              {/* Resume Button */}
              <a href="/Shahzaib Rehman.pdf" download="Shahzaib_Rehman_Resume.pdf">
                <Button
                  borderRadius="1.75rem"
                  className="bg-black text-white border border-neutral-800 hover:bg-black/90 hover:border-neutral-700 px-6 md:px-8 py-3 md:py-4"
                >
            ...
            {/* Mobile Layout - 2+1 button arrangement */}
            <div className="flex flex-col items-center gap-3 sm:hidden w-full max-w-xs">
              {/* Top row - LinkedIn and GitHub buttons */}
              <div className="flex flex-row gap-3 justify-center w-full">
                <a href="https://www.linkedin.com/in/shahzaib-rehman-1246591a6/" target="_blank" rel="noopener noreferrer" className="flex-1">
                  <Button
                    borderRadius="1.75rem"
                    className="bg-black text-white border border-neutral-800 hover:bg-black/90 hover:border-neutral-700 px-3 py-2.5 w-full"
                  >
                    <div className={`${inter.className} flex items-center justify-center gap-1`}>
                ...
                <a href="https://github.com/CodingWithShahzaib" target="_blank" rel="noopener noreferrer" className="flex-1">
                  <Button
                    borderRadius="1.75rem"
                    className="bg-black text-white border border-neutral-800 hover:bg-black/90 hover:border-neutral-700 px-3 py-2.5 w-full"
                  >
              ...
              {/* Bottom row - Resume button centered */}
              <div className="flex justify-center w-full">
                <a href="/Shahzaib Rehman.pdf" download="Shahzaib_Rehman_Resume.pdf" className="w-48">
                  <Button
                    borderRadius="1.75rem"
                    className="bg-black text-white border border-neutral-800 hover:bg-black/90 hover:border-neutral-700 px-6 py-2.5 w-full"
                  >
                    <div className={`${inter.className} flex items-center justify-center gap-2`}>
        ...
        <motion.div
          ...
          className="absolute bottom-4 sm:bottom-6 md:bottom-8 left-0 right-0 flex justify-center cursor-pointer z-20"
          onClick={() => {
        ...
        >
          <div className="flex flex-col items-center gap-1 sm:gap-2 group">
            <span className={`${inter.className} text-neutral-400 text-xs font-medium group-hover:text-neutral-200 transition-colors hidden sm:block`}>
              Scroll to explore
            </span>
            <motion.div
              animate={{ y: [0, 6, 0] }}
              ...
              className="flex items-center justify-center p-1.5 sm:p-2 rounded-full border border-neutral-600 group-hover:border-neutral-400 transition-colors w-8 h-8 sm:w-10 sm:h-10"
            >
              <svg
                className="w-3 h-3 sm:w-4 sm:h-4 text-neutral-400 group-hover:text-neutral-200 transition-colors"
                fill="none"
                stroke="currentColor"
                viewBox="0 0 24 24"
              >
