...
const NavbarLogo = () => {
  return (
    ...
    >
      <span className="text-xl font-bold bg-clip-text text-transparent bg-gradient-to-b from-neutral-50 to-neutral-400">Portfolio</span>
    </a>
  );
};
    ...
    <div className={cn(
      ...
      <ResizableNavbar>
        ...
        <MobileNav>
          <MobileNavHeader>
            <NavbarLogo />
            <MobileNavToggle isOpen={mobileMenuOpen} onClick={toggleMobileMenu} />
          </MobileNavHeader>
